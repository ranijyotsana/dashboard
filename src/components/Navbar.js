      ...
      <div className='max-w-6xl mx-auto flex items-center justify-between p-4'>
        ...
        <nav className='flex items-center gap-4'>
          <Link
            className={
              'px-3 py-2 rounded ' + 
              (loc.pathname==='/' ? 'bg-slate-100 dark:bg-gray-800' : 'hover:bg-slate-50 dark:hover:bg-gray-800')
            }
            to='/'
          >Dashboard</Link>
          ...
          <Link
            className={
              'px-3 py-2 rounded ' + 
              (loc.pathname==='/analytics' ? 'bg-slate-100 dark:bg-gray-800' : 'hover:bg-slate-50 dark:hover:bg-gray-800')
            }
            to='/analytics'
          >Analytics</Link>
          ...
          <button
            ...
            className='ml-3 px-3 py-2 rounded border dark:border-gray-700'
          >
            {dark ? '☀️ Light' : '🌙 Dark'}
          </button>
        </nav>
